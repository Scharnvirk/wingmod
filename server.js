...
var SampleApp = function() {
    ...
    self.populateCache = function() {
        ...
        self.zcache['/models/ravier_gunless.json'] = fs.readFileSync('./models/ravier_gunless.json');
        ...
        self.zcache['/models/lasgun.json'] = fs.readFileSync('./models/lasgun.json');
        self.zcache['/models/lasgun.png'] = fs.readFileSync('./models/lasgun.png');
        self.zcache['/models/lasgun_B.png'] = fs.readFileSync('./models/lasgun_B.png');
        self.zcache['/models/plasmagun.json'] = fs.readFileSync('./models/plasmagun.json');
    ...
    self.createRoutes = function() {
        ...
        self.routes['/models/ravier_gunless.json'] = function(req, res) {res.send(self.cache_get('/models/ravier_gunless.json') );};
        ...
        self.routes['/models/lasgun.json'] = function(req, res) {res.send(self.cache_get('/models/lasgun.json') );};
        self.routes['/models/lasgun.png'] = function(req, res) {res.send(self.cache_get('/models/lasgun.png') );};
        self.routes['/models/lasgun_B.png'] = function(req, res) {res.send(self.cache_get('/models/lasgun_B.png') );};
        self.routes['/models/plasmagun.json'] = function(req, res) {res.send(self.cache_get('/models/plasmagun.json') );};
